...
K = np.array([[1.06712744,      -0.00000873,     6.40188626],
              [-0.00000873,     1.06469527,     4.83513625],
              [-0.00000873,     -0.00000873,     1.02464257]], dtype=np.float)

# Get a pair of images of the same object form different viewpoint
img1 = cv2.imread('DataSet/Beats1.jpg')
img2 = cv2.imread('DataSet/Beats1.jpg')
